...
#let's build a simple deep learning model
require(h2o)
#start h2o
...
#let's train a deep learning model with one hidden layer comprising five neurons.
deepmodel<-h2o.deeplearning(x = x      
                            ,y = y      
                            ,training_frame = trainh2o      
...
#mxnet accepts target variables as numeric classes and not factors. Also, it accepts data frame as a matrix. 
#load package
require(mxnet)
...
test.y <- test$target
#train the multilayered perceptron model using the mx.mlp function.
...
#network performs terribly on this data. On this data set, xgboost tuning gave 87% accuracy.
